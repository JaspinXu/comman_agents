...
SEED_AGENTS = [
    AgentConfig.model_validate({
        ...
        "customAttributes": [{"name": "沟通方式", "content": "先追问事实与证据，再给出判断。"}],
    ...
    AgentConfig.model_validate({
        ...
        "customAttributes": [{"name": "风险偏好", "content": "宁可降低速度，也不接受不可恢复的系统性风险。"}],
    ...
    AgentConfig.model_validate({
        ...
        "customAttributes": [{"name": "冲突处理", "content": "先让分歧被完整表达，再寻找能够共同验证的部分。"}],
